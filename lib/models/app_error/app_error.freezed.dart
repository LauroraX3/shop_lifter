...
/// @nodoc
mixin _$AppError {
  Object get errorBody => throw _privateConstructorUsedError;
...
abstract class $AppErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({Object errorBody, String message});
}
...
class _$AppErrorCopyWithImpl<$Res, $Val extends AppError>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      errorBody: null == errorBody ? _value.errorBody : errorBody,
...
class _$AppErrorImpl implements _AppError {
  const _$AppErrorImpl({required this.errorBody, required this.message});
  ...
  @override
  String toString() {
    return 'AppError(errorBody: $errorBody, message: $message)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(errorBody), message);
...
abstract class _AppError implements AppError {
  const factory _AppError(
      {required final Object errorBody,
      required final String message}) = _$AppErrorImpl;
